...
namespace NeptuneEvo.Core
{
    class Doormanager : Script
    {
        ...
        //private static List<uint> doors = new List<uint>()
        //{
        //    308262790,
        //};

        //[RemoteEvent("buyVendingSprunk")]
        //public static void FinishBuilderWork(Player player)
        //{
        //    try
        //    {
        //        Notify.Send(player, NotifyType.Success, NotifyPosition.BottomCenter, "есть");
        //    }
        //    catch (Exception ex)
        //    {
        //        Log.Write("FinishBuilderWork: " + ex.StackTrace, nLog.Type.Error);
        //    }
        //}
        ...
        public void onResourceStart()
        {
            try
            {
                //foreach (var item in NAPI.Pools.GetAllObjects())
                //{
                //    if (doors.Contains(item.Model))
                //    {
                //        item.SetSharedData("ISDOOR", true);
                //        item.SetSharedData("DOORLOCKSTATUS", false);
                //    }
                //}
