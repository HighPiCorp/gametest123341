...
//            catch (Exception e)
//            {
//                Log.Write($"Контейнеры: {e.StackTrace}", nLog.Type.Error);
//            }
//        }
//        #endregion
...
//        {
//            if (!player.HasMyData("ContainerID")) return;
//            Container container = containers[player.GetMyData<int>("ContainerID")];
...
//            catch (Exception e)
//            {
//                Log.Write(e.StackTrace, nLog.Type.Error);
//            }
//        }
//        #endregion
//    }
...
//            {
//                if (!State) return;
//                //player.SetMyData("INTERACTIONCHECK", 814);
//                //player.SetMyData("ContainerID", ID);
...
//                //player.ResetMyData("ContainerID");
...
//            int vNumber = -1;
//            vNumber = VehicleManager.Create(player.Name, Main.Players[player].UUID, vName, new Color(0, 0, 0), new Color(0, 0, 0), new Color(0, 0, 0));
