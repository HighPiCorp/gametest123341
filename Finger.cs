...
namespace NeptuneEvo.Core
{
    class Fingerpointing : Script
    {
        ...
        {
            var activeWeapon = nInventory.Items[Main.Players[sender].UUID].FirstOrDefault(i => (nInventory.WeaponsItems.Contains(i.Type) || nInventory.MeleeWeaponsItems.Contains(i.Type)) && i.IsActive);
