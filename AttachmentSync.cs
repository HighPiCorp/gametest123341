...
namespace NeptuneEvo.Core
{
    public static class AttachmentSync
    {
        ...
        public static void AddAttachment(this Entity entity, object attachment, bool remove)
        {
            ...
            if (attachment.GetType() == typeof(string))
                attachmentHash = NAPI.Util.GetHashKey((string)attachment);
            else
            ...
            Console.WriteLine("AddAtachment "+ attachmentHash);
        ...
        public static bool HasAttachment(this Entity entity, object attachment)
        {
            if (!entity.HasData("Attachments"))
                return false;
